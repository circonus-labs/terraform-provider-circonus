		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.990896688", "CPUUtilization"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.3895259375", "DatabaseConnections"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.1328149445", "DiskQueueDepth"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.4218650584", "FreeStorageSpace"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.1835248983", "FreeableMemory"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.2757008135", "MaximumUsedTransactionIDs"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.915415866", "NetworkReceiveThroughput"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.1852047735", "NetworkTransmitThroughput"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.3518416306", "ReadIOPS"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.114013313", "ReadLatency"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.1284099341", "ReadThroughput"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.4205329773", "SwapUsage"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.3550163941", "TransactionLogsDiskUsage"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.2231806695", "TransactionLogsGeneration"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.335777904", "WriteIOPS"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.3894876280", "WriteLatency"),
					resource.TestCheckResourceAttr("circonus_check.rds_metrics", "cloudwatch.46539847.metric.1569904650", "WriteThroughput"),
