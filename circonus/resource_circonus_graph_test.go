...
func TestAccCirconusGraph_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{ // Create a graph without some settings.
				Config: fmt.Sprintf(testAccCirconusGraphRemoveConfigFmt,
					graphCheckName,
					testAccBroker1,
					graphName,
					" foo",
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("circonus_graph.mixed-points", "notes"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "graph_style", "line"),
					resource.TestCheckNoResourceAttr("circonus_graph.mixed-points", "left.%"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "right.%", "2"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "right.logarithmic", "10"),
					resource.TestCheckNoResourceAttr("circonus_graph.mixed-points", "right.max"),
					...
					resource.TestCheckNoResourceAttr("circonus_graph.mixed-points", "tags.#"),
				),
			},
			{ // Add those settings.
			...
			{ // force removal of settings to verify they are removed from the graph.
				Config: fmt.Sprintf(testAccCirconusGraphRemoveConfigFmt,
					graphCheckName,
					testAccBroker1,
					graphName,
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "name", graphName),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "description", "Terraform Test: mixed graph foo"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "notes", ""),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "graph_style", "line"),
					resource.TestCheckNoResourceAttr("circonus_graph.mixed-points", "left.%"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "right.%", "2"),
					resource.TestCheckResourceAttr("circonus_graph.mixed-points", "right.logarithmic", "10"),
...
const testAccCirconusGraphRemoveConfigFmt = `
variable "test_tags" {
  type = list(string)
  default = [ "author:terraform", "lifecycle:unittest" ]
}
